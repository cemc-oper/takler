...
def create_flow():
    ...
    task1.add_parameter(
        "TAKLER_SCRIPT", str(Path(TAKLER_HOME, "test/task1_with_meter.takler"))
    )
    # t1 reports its progress while running by updating meter "step" (0~100).
    ...
    # t2 runs once t1's meter "step" reaches 50.
    task2.add_trigger("./t1:step >= 50")
